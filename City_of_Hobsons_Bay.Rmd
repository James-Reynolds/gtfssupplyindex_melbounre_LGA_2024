...
sa1s_in_other_lgas <- lga2021 %>% 
  filter(lga_name_2021 == "Maribyrnong" | lga_name_2021 == "Moonee Valley" | lga_name_2021 == "Moreland" | lga_name_2021 == "Darebin" | lga_name_2021 == "Banyule" | lga_name_2021 == "Boroondara" | lga_name_2021 == "Stonnington" | lga_name_2021 == "Glen Eira" | lga_name_2021 == "Bayside (Vic.)") 
...
Figure 1 compares social needs for LGAs similarly located in the middle suburbs^[LGAs: Maribyrnong, Moonee Valley, Merri-Bek, Darebin, Banyule, Boroondara, Stonnington, Glen Eira and Bayside.]
and the outer parts of Greater Melbourne^[i.e. LGAs beyond those listed above.] with
...
inset_element(pcol, left = 0.60, bottom = 0.64, right = 1.05, top =0.98) +
 inset_element(pcol_rest_SA4, left = 0.70, bottom = 0.32, right = 1.05, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.70, bottom = 0.0, right = 1.05, top = 0.34) 
...
#  geom_sf(data=ptv_210804_gtfs, colour="purple") + 
 ...
 # ggspatial::annotation_scale(location = 'bl') +
  ...
  inset_element(pcol, left = 0.5, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4, left = 0.65, bottom = 0.33, right = 1.0, top =0.66) +
...
inset_element(pcol_2, left = 0.5, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4_2, left = 0.65, bottom = 0.33, right = 1.0, top =0.66) +
 inset_element(pcol_rest_melbourne_2, left = 0.65, bottom = 0.0, right = 1.0, top = 0.33) 
...
pcol_1 <- si_by_area_2021_2023_wider_holding %>%
  ...
  guides(fill = "none", color = "none") +
  labs(
 title = "All City of Hobsons Bay SA1s",
    x = NULL,
    y = NULL
  ) +
  theme_void() +
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  inset_element(pcol_1, left = 0.272, bottom = 0.5, right = 0.6, top =1.05) +
 inset_element(pcol_rest_SA4_2, left = 0.6, bottom = 0.5, right = 0.8, top =1.05) +
...
2021, which is lower than for the rest of Inner SA4
...
Differences with the outer parts of Greater Melbourne were not statistically significant
...
below Melbourne's average,
and more likely to have seen increases, 
including for those with larger needs-gaps, but 
not for those with higher needs-gaps.
