...
This note uses
the Currie and Sendbergs (2007) methodology[@Currie2007Identifying; @currie2010identifying].
...
inset_element(pcol, left = 0.59, bottom = 0.64, right = 1.04, top =1.0) +
 inset_element(pcol_rest_SA4, left = 0.72, bottom = 0.32, right = 1.04, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.72, bottom = 0.0, right = 1.04, top = 0.34) 
...
outer parts of Melbourne (`r label_percent(accuracy=1)(pcol_rest_melbourne$data[1:4,3] %>% sum())`)^[Differences
were statistically significant
...
Transit levels increased by 1% or more by 2023 in SA1s that were home to `r label_percent(accuracy=1)(pcol_1$data[1:5,3] %>% sum())` of City of Hobsons Bay residents in
...
were statistically significant
(`r prmisc::print_chi2(melbourne_2023_SA1_comparison)`).] or the or more outer parts of Greater Melbourne  (`r label_percent(accuracy=1)(pcol_rest_melbourne_3$data[1:5,3] %>% sum())`)^[Differences 
were statistically significant
...
(`r label_percent(accuracy=1)(pcol_rest_SA4$data[2:5,4] %>% sum())`)^[Differences
were statistically significant
(Fisher test p = `r melbourne_2021_SA1_comparison_very_high_needs$p.value %>% format(digits = 3)`).] or 
(`r label_percent(accuracy=1)(pcol_rest_melbourne$data[2:5,4] %>% sum())`)^[Differences with the outer parts of Greater Melbourne were also statistically significant
