...
which is a lower share than for similarly located seats
...
Figure 3 compares 2021 and 2023 service levels. 
...
the Melbourne averages in 2021^[Shown with black outline and cross hatching in Figure 3. This compares to 
...
For `r label_percent(accuracy=1)(pcol$data[1:5,4] %>% sum())` of this cohort service levels increased 1% or more by 2023, which is a lower proportion than for the similar cohorts in similarly located seats (`r label_percent(accuracy=1)(pcol_rest_SA4$data[1:6,4] %>% sum())`)^[Differences
were statistically significant (Fisher test p = `r melbourne_2021_SA1_comparison_needs$p.value %>% format(digits = 3)`)] 
or the rest of Greater Melbourne (`r label_percent(accuracy=1)(pcol_rest_SA4$data[1:6,4] %>% sum())`)^[Difference were statistically significant
