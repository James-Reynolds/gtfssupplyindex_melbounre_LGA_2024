...
```{r SI_change_map, fig.show="hold", eval = TRUE, echo = FALSE, warning=FALSE, message=FALSE, cache=FALSE, fig.fullwidth = FALSE, fig.cap="Transit service change 2021 to 2023. SA1s with needs above, but supply below, average highlighted in black."}
...
to have been more likely to have less transit supply than Melbourne's average than those in surrounding seats or the rest of Melbourne, and less likely to have seen service increases between 2021 and 2023.
