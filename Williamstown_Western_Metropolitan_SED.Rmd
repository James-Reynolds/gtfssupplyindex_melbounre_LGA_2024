...
inset_element(pcol, left = 0.45, bottom = 0.66, right = 1.1, top =1.05) +
 inset_element(pcol_rest_SA4, left = 0.575, bottom = 0.33, right = 1.1, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.575, bottom = 0.0, right = 1.1, top = 0.33) 
...
(`r label_percent(accuracy=1)(pcol_rest_SA4$data[4:6,3] %>% sum())`)^[Differences 
were statistically significant (`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`)]
and the rest of Greater Melbourne (`r label_percent(accuracy=1)(pcol_rest_melbourne$data[4:6,3] %>% sum())`)^[Differences were statistically significant (`r prmisc::print_chi2(melbourne_2021_SA4_comparison_needs)`).]. 
...
(`r label_percent(accuracy=1)(pcol_rest_SA4$data[1:4,3] %>% sum())`)^[Differences
were statistically significant
(`r prmisc::print_chi2(melbourne_2023_SA1_comparison)`).]
or the rest of Melbourne (`r label_percent(accuracy=1)(pcol_rest_melbourne$data[1:4,3] %>% sum())`)^[Differences
were statistically significant
...
Transit levels increased by 1% or more by 2023 in SA1s that were home to `r label_percent(accuracy=1)(pcol_1$data[1:3,3] %>% sum())` of Williamstown (W Metro) residents in
2021, which is a larger share than for similarly located seats
(`r label_percent(accuracy=1)(pcol_rest_SA4_2$data[1:3,3] %>% sum())`)^[Differences 
were statistically significant
(`r prmisc::print_chi2(melbourne_2023_SA1_comparison)`).] or the rest of Greater Melbourne (`r label_percent(accuracy=1)(pcol_rest_melbourne_3$data[1:3,3] %>% sum())`)^[Differences 
were statistically significant
...
However, for `r label_percent(accuracy=1)(pcol$data[1:3,4] %>% sum())` of this cohort service levels increased 1% or more, a higher proportion than
for the similar cohort living in similarly located seats (`r label_percent(accuracy=1)(pcol_rest_SA4$data[1:3,4] %>% sum())`)^[Differences
were statistically significant
(Fisher test p = `r melbourne_2021_SA1_comparison_needs$p.value %>% format(digits = 3)`)]
or the rest of Greater Melbourne
(`r label_percent(accuracy=1)(pcol_rest_melbourne$data[1:3,4] %>% sum())`)^[Differences
were statistically significant
