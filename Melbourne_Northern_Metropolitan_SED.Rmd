...
formed from amongst Members of Parliament
...
This note examines
the Melbourne (Northern Metropolitan) State Electoral Division
in 2021 and 2023,
...
This share was similar to the rest of the Inner SA4 (`r label_percent(accuracy=0.1)(pcol_rest_SA4$data[4:6,3] %>% sum())`)^[Differences
were statistically significant (`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`).], 
but higher than among those elsewhere in Greater Melbourne (`r label_percent(accuracy=0.1)(pcol_rest_melbourne$data[4:6,3] %>% sum())`)^[Differences
...
pcol_1 <- si_by_area_2021_2023_wider_holding %>%
  ...
  guides(fill = "none", color = "none") +
  labs(
 title = "All Melbourne (Nth Metro) SA1s",
    x = NULL,
    y = NULL
  ) +
  theme_void() +
...
Transit levels increased by 1% or more by 2023 in SA1s that were home to `r label_percent(accuracy=0.1)(pcol_1$data[1:5,3] %>% sum())` of Melbourne (Nth Metro) residents in
...
However, for `r label_percent(accuracy=0.1)(pcol$data[1,4] %>% sum())` of this cohort service levels increased 1% or more, a higher proportion than
for the similar cohort living elsewhere in Melbourne but outside the Inner SA1
