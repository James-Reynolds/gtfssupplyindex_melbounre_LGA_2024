...
of the Yarra population, more than elsewhere in Melbourne (`r label_percent(accuracy=0.1)(pcol_rest_melbourne$data[4:6,3] %>% sum())`)^[Differences between Yarra and the rest of the Inner and Inner East SA4s were not statistically significant (`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`). Differences with the rest of Greater Melbourne were statistically significant (`r prmisc::print_chi2(melbourne_2021_SA4_comparison_needs)`).].
...
for `r label_percent(accuracy=0.1)(pcol_1$data[1:5,3] %>% sum())` of Yarra residents, which is a great proportion than in the rest of Inner and Inner East SA4s (`r label_percent(accuracy=0.1)(pcol_rest_melbourne_3$data[1:5,3] %>% sum())`)^[Differences 
were statistically significant
