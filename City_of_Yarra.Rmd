...
for `r label_percent(accuracy=0.1)(pcol_1$data[1:5,3] %>% sum())` of Yarra residents
, which is similar to the rest of Inner and Inner East SA4s^[Differences 
were not statistically significant
(`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`).], but
higher than for those in the rest of Melbourne (`r label_percent(accuracy=0.1)(pcol_rest_melbourne_3$data[1:5,3] %>% sum())`)^[Differences 
were statistically significant
