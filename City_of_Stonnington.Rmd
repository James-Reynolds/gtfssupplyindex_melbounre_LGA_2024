...
inset_element(pcol, left = 0.40, bottom = 0.64, right = 1.05, top =0.98) +
 inset_element(pcol_rest_SA4, left = 0.5, bottom = 0.32, right = 1.05, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.5, bottom = 0.0, right = 1.05, top = 0.34) 
...
of the Stonnington population, a greater share than 
...
or elsewhere in Melbourne (`r label_percent(accuracy=0.1)(pcol_rest_melbourne$data[4:6,3] %>% sum())`)^[Differences
...
#  geom_sf(data=ptv_210804_gtfs, colour="purple") + 
 ...
 # ggspatial::annotation_scale(location = 'bl') +
  ...
  inset_element(pcol, left = 0.3, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4, left = 0.5, bottom = 0.33, right = 1.0, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.5, bottom = 0.0, right = 1.0, top = 0.33) 
...
#  geom_sf(data=ptv_210804_gtfs, colour="purple") + 
  ...
  ggspatial::annotation_scale(location = 'bl') +
 # ggspatial::annotation_north_arrow(location = 'bl', height = unit(0.75, "cm"), width = unit(0.75, "cm")) + 
inset_element(pcol_2, left = 0.3, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4_2, left = 0.5, bottom = 0.33, right = 1.0, top =0.66) +
 inset_element(pcol_rest_melbourne_2, left = 0.5, bottom = 0.0, right = 1.0, top = 0.33) 
...
pcol_1 <- si_by_area_2021_2023_wider_holding %>%
  ...
  geom_hline(yintercept = 0)  + 
  geom_text(aes(ratio_binned, 0.9, label = glue::glue("{label_comma(accuracy = 1, big.mark = ",")(population)} ({label_percent(accuracy = 1)(perc)})")), size = 1.5) +
   coord_flip() +
...
pcol_rest_melbourne_3 <- si_by_area_2021_2023_wider_holding %>%
  ...
  scale_y_continuous(limits = c(0,1.2)) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(ratio_binned,  .9, label = glue::glue("{label_comma(accuracy = 1, big.mark = ",")(population)} ({label_percent(accuracy = 1)(perc)})")), size = 1.5) +
   coord_flip() +
     scale_fill_manual(values = c("Increased 30%+ or new" = "#3A65A3", "Increased 10 to 30%" = "#6D9DC4", "Increased 5 to 10%" = "#DDEFF5",  "Increased 3 to 5%" = "#FFFBB5",  "Increased 1 to 3%" = "#F9D785",  "Within 1%" = "#EFA15C", "Reduced 1 to 3%" = "#DC6446", "Reduced 3 to 10%" = "#BA3832", "Reduced 10% or more" = "#852128", "Not served in 2023" = "black", drop=FALSE))  +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
pcol <- si_by_area_2021_2023_wider_holding %>%
 ...
 na.omit() %>%
  ...
  scale_x_discrete(drop=FALSE) +
  geom_hline(yintercept = 0)  + 
  geom_text(aes(ratio_binned_less, 0.9, label = glue::glue("{label_comma(accuracy = 1, big.mark = ",")(population)} ({label_percent(accuracy = 1)(perc)})")), size = 1.5) +
   coord_flip() + 
     scale_fill_manual(values = c("Increased 30%+ or new" = "#3A65A3", "Increased 10 to 30%" = "#6D9DC4", "Increased 5 to 10%" = "#DDEFF5",  "Increased 3 to 5%" = "#FFFBB5",  "Increased 1 to 3%" = "#F9D785",  "Within 1%" = "#EFA15C", "Reduced 1 to 3%" = "#DC6446", "Reduced 3 to 10%" = "#BA3832", "Reduced 10% or more" = "#852128", "Not served in 2023" = "black", drop=FALSE))  +
  scale_color_manual(values = c(rep("black", 5), rep("white", 2), "black")) +
  guides(fill = "none", color = "none") +
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  inset_element(pcol_1, left = 0.23, bottom = 0.6, right = 0.6, top =1.05) +
 inset_element(pcol_rest_SA4_2, left = 0.6, bottom = 0.6, right = 0.8, top =1.05) +
 inset_element(pcol_rest_melbourne_3, left = 0.8, bottom = 0.6, right = 1.0, top = 1.05) +
inset_element(pcol, left = 0.4, bottom = 0.1, right = 0.6, top =0.5) +
 inset_element(pcol_rest_SA4, left = 0.6, bottom = 0.1, right = 0.8, top =0.5) +
 inset_element(pcol_rest_melbourne, left = 0.8, bottom = 0.1, right = 1.0, top = 0.5) 
...
compared to `r label_percent(accuracy=0.1)(pcol_rest_SA4_2$data[1:5,3] %>% sum())` of those in the rest of 
the Inner and Inner South SA4s^[Differences 
were statistically significant
(`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`).]
and `r label_percent(accuracy=0.1)(pcol_rest_melbourne_3$data[1:5,3] %>% sum())` of those in the rest of 
...
However, for `r label_percent(accuracy=0.1)(pcol$data[1:3,4] %>% sum())` of this cohort service levels increase 1% or more, a higher proportion than
...
were statistically significant
(`r melbourne_2021_SA4_comparison_needs`).].
