...
inset_element(pcol, left = 0.45, bottom = 0.66, right = 1.1, top =1.05) +
 inset_element(pcol_rest_SA4, left = 0.60, bottom = 0.33, right = 1.1, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.60, bottom = 0.0, right = 1.1, top = 0.33) 
...
of the seat of Clarinda's population^[Differences between the seat of Clarinda and similarly located seats, or with the rest of Greater Melbourne were not statistically significant (`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`)(`r prmisc::print_chi2(melbourne_2021_SA4_comparison_needs)`)]. 
