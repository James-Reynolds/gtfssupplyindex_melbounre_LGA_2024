...
Transit levels increased by 1% or more for `r label_percent(accuracy=0.1)(pcol_1$data[1:6,3] %>% sum())` of Kingston residents
between 2021 and 2023,
which is a lower proportion than for the rest of the Inner South and South East SA4s (`r label_percent(accuracy=0.1)(pcol_rest_SA4_2$data[1:6,3] %>% sum())`)^[Differences were statistically significant 
(`r prmisc::print_chi2(melbourne_2023_SA1_comparison)`).], but slightly higher than for the rest of Greater Melbourne (`r label_percent(accuracy=0.1)(pcol_rest_melbourne_3$data[1:6,3] %>% sum())`)^[Differences were statistically significant
...
were statistically significant 
(`r prmisc::print_chi2(melbourne_2021_SA1_comparison_very_high_needs)`)] 
or the rest of Melbourne
(`r label_percent(accuracy=0.1)(pcol_rest_melbourne$data[1:7,4] %>% sum())`)^[Differences were statistically significant (`r prmisc::print_chi2(melbourne_2021_SA4_comparison_very_high_needs)`).].

Overall, Kingston residents had less transit than others in the Inner South and South East SA4s, but more than those elsewhere. Those with greater needs-gaps in Kingston in 2021 were less likely to have seen transit increase by 2023 than those elsewhere. 
