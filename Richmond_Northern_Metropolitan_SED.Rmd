...
This share was higher than among the parts of Greater Melbourne that are beyond the Inner SA4 (`r label_percent(accuracy=1)(pcol_rest_melbourne$data[4:6,3] %>% sum())`)^[Differences with parts of Melbourne that are beyond the Inner SA4
...
Transit levels increased by 1% or more by 2023 in SA1s that were home to `r label_percent(accuracy=1)(pcol_1$data[1:5,3] %>% sum())` of Richmond (Nth Metro) residents in
...
(`r label_percent(accuracy=1)(pcol_rest_melbourne$data[1:5,4] %>% sum())`)^[Differences
...
were no statistically significant differences between the Richmond (Nth Metro) seat and the rest of the Inner SA4
