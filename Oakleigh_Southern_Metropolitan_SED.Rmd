...
inset_element(pcol, left = 0.7, bottom = 0.66, right = 1.0, top =1.05) +
 inset_element(pcol_rest_SA4, left = 0.85, bottom = 0.33, right = 1.0, top =0.68) +
 inset_element(pcol_rest_melbourne, left = 0.85, bottom = 0.0, right = 1.0, top = 0.35) 
...
#  geom_sf(data=ptv_210804_gtfs, colour="purple") + 
 ...
 inset_element(pcol_rest_SA4, left = 0.65, bottom = 0.1, right = 1.05, top =0.6) +
 inset_element(pcol_rest_melbourne, left = 0.65, bottom = 0.6, right = 1.05, top = 1.0) 
...
inset_element(pcol_2, left = 0.0, bottom = 0.0, right = 0.55, top =0.45) +
 inset_element(pcol_rest_SA4_2, left = 0.65, bottom = 0.1, right = 1.05, top =0.6) +
 inset_element(pcol_rest_melbourne_2, left = 0.65, bottom = 0.6, right = 1.05, top = 1.0) 
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  inset_element(pcol_1, left = 0.35, bottom = 0.50, right = 0.67, top =1.05) +
 inset_element(pcol_rest_SA4_2, left = 0.67, bottom = 0.50, right = 0.83, top =1.05) +
 inset_element(pcol_rest_melbourne_3, left = 0.83, bottom = 0.50, right = 1.0, top = 1.05) +
inset_element(pcol, left = 0.5, bottom = 0.0, right = 0.67, top =0.55) +
 inset_element(pcol_rest_SA4, left = 0.67, bottom = 0.0, right = 0.8, top =0.55) +
 inset_element(pcol_rest_melbourne, left = 0.83, bottom = 0.0, right = 1.0, top = 0.55) 
...
were no statistically significant with similarly located seats
