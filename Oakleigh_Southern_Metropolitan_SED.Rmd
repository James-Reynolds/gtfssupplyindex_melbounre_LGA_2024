...
lon = c(bbox_list[[1]]["xmin"] %>% as.numeric(), bbox_list[[1]]["xmax"] %>% as.numeric() + 0.3*(bbox_list[[1]]["xmax"] %>% as.numeric() - bbox_list[[1]]["xmin"] %>% as.numeric()))
...
inset_element(pcol, left = 0.62, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4, left = 0.75, bottom = 0.33, right = 1.0, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.75, bottom = 0.0, right = 1.0, top = 0.33) 
...
of the seat of Oakleigh's population^[Differences were not statistically significant between the seat of Oakleigh and similarly located seats (`r prmisc::print_chi2(melbourne_2021_SA1_comparison_needs)`) or the rest of Greater Melbourne (`r prmisc::print_chi2(melbourne_2021_SA4_comparison_needs)`)]. 
...
lat = c(bbox_list[[1]]["ymin"] %>% as.numeric(), bbox_list[[1]]["ymax"] %>% as.numeric())
lon = c(bbox_list[[1]]["xmin"] %>% as.numeric(), bbox_list[[1]]["xmax"] %>% as.numeric() + 0.15*(bbox_list[[1]]["xmax"] %>% as.numeric() - bbox_list[[1]]["xmin"] %>% as.numeric()))
...
#  geom_sf(data=ptv_210804_gtfs, colour="purple") + 
 ...
 # ggspatial::annotation_scale(location = 'tr') +
  ...
  inset_element(pcol, left = 0.65, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4, left = 0.8, bottom = 0.33, right =1.0, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.8, bottom = 0.0, right = 1.0, top = 0.33) 
...
#  geom_sf(data=ptv_210804_gtfs, colour="purple") + 
 ...
 inset_element(pcol_2, left = 0.65, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4_2, left = 0.8, bottom = .33, right = 1.0, top =0.66) +
 inset_element(pcol_rest_melbourne_2, left = 0.8, bottom = 0.0, right = 1.0, top = 0.33) 
...
of Oakleigh (S Metro) residents in 2021, which is a lower proportion than for 
similarly located seats (`r label_percent(accuracy=0.1)(pcol_rest_SA4$data[1:4,3] %>% sum())`)^[Difference were statistically significant (`r prmisc::print_chi2(melbourne_2023_SA1_comparison)`)] for the rest of Melbourne (`r label_percent(accuracy=0.1)(pcol_rest_melbourne$data[1:4,3] %>% sum())`)^[Differences
...
lat = c(bbox_list[[1]]["ymin"] %>% as.numeric(), bbox_list[[1]]["ymax"] %>% as.numeric())
lon = c(bbox_list[[1]]["xmin"] %>% as.numeric(), bbox_list[[1]]["xmax"] %>% as.numeric() + 0.5*(bbox_list[[1]]["xmax"] %>% as.numeric() - bbox_list[[1]]["xmin"] %>% as.numeric()))
...
#        legend.key.size = unit(0.08, 'cm')
  ...
  inset_element(pcol_1, left = 0.48, bottom = 0.66, right = 0.8, top =1.0) +
 inset_element(pcol_rest_SA4_2, left = 0.6, bottom = 0.33, right = 0.8, top =0.66) +
 inset_element(pcol_rest_melbourne_3, left = 0.6, bottom = 0.0, right = 0.8, top = 0.33) +
inset_element(pcol, left = 0.8, bottom = 0.66, right = 1.0, top =1.0) +
 inset_element(pcol_rest_SA4, left = 0.8, bottom = 0.33, right = 1.0, top =0.66) +
 inset_element(pcol_rest_melbourne, left = 0.8, bottom = 0.0, right = 1.0, top = 0.33) 
...
Transit levels increased by 1% or more by 2023 in SA1s that were home to
`r label_percent(accuracy=0.1)(pcol_1$data[1:5,3] %>% sum())`
of Oakleigh (S Metro) residents in
2021,
which is a larger share than for similarly located seats
(`r label_percent(accuracy=0.1)(pcol_rest_SA4_2$data[1:5,3] %>% sum())`)^[
Differences 
were statistically significant
(`r prmisc::print_chi2(melbourne_2023_SA1_comparison)`).]
or the rest of Greater Melbourne
(`r label_percent(accuracy=0.1)(pcol_rest_melbourne_3$data[1:5,3] %>% sum())`)^[
Differences 
were statistically significant
(`r prmisc::print_chi2(melbourne_2023_SA4_comparison)`).]. `r label_percent(accuracy = 0.1)(si_by_area_2021_2023_wider_holding %>% filter(group == "Oakleigh (S Metro)") %>% st_drop_geometry() %>% filter(composite_needs == "Very High" | composite_needs == "High" | composite_needs == "Above average") %>% filter(transit_supply_2021 == "Below average" | transit_supply_2021 == "Low" | transit_supply_2021 == "Very Low" | transit_supply_2021 == "Zero Supply") %>% na.omit() %>% select(population) %>% sum() / si_by_area_2021_2023_wider_holding %>% filter(group == "Oakleigh (S Metro)") %>% st_drop_geometry() %>% select(population) %>% sum())`
of the Oakleigh (S Metro) population lived in SA1s with
*needs above, but supply below*
the Melbourne averages in 2021^[
Shown with black in Figure 3. This compares to 
`r label_percent(accuracy = 0.1)(si_by_area_2021_2023_wider_holding %>% filter(group == "Similar seats") %>% st_drop_geometry() %>% filter(composite_needs == "Very High" | composite_needs == "High" | composite_needs == "Above average") %>% filter(transit_supply_2021 == "Below average" | transit_supply_2021 == "Low" | transit_supply_2021 == "Very Low" | transit_supply_2021 == "Zero Supply") %>% na.omit() %>% select(population) %>% sum() / si_by_area_2021_2023_wider_holding %>% filter(group == "Similar seats") %>% st_drop_geometry() %>% select(population) %>% sum())`
of residents of similarly located seats and 
`r label_percent(accuracy = 0.1)(si_by_area_2021_2023_wider_holding %>% filter(group == "Rest of Greater Melbourne") %>% st_drop_geometry() %>% filter(composite_needs == "Very High" | composite_needs == "High" | composite_needs == "Above average") %>% filter(transit_supply_2021 == "Below average" | transit_supply_2021 == "Low" | transit_supply_2021 == "Very Low" | transit_supply_2021 == "Zero Supply") %>% na.omit() %>% select(population) %>% sum() / si_by_area_2021_2023_wider_holding %>% filter(group == "Rest of Greater Melbourne") %>% st_drop_geometry() %>% select(population) %>% na.omit() %>% sum())`
of those elsewhere in Melbourne.].
However, for
`r label_percent(accuracy=0.1)(pcol$data[1:5,4] %>% sum())`
of this cohort service levels increased 1% or more^[
Differences were not statistically significant
with the similar cohorts in similarly located seats
(Fisher test p = 
`r melbourne_2021_SA1_comparison_needs$p.value %>% format(digits = 3)`)
or the rest of Greater Melbourne (Fisher test p = `r melbourne_2021_SA4_comparison_needs$p.value %>% format(digits = 3)`).].

Overall, Oakleigh (S Metro) residents appear
to higher transit service levels than those in similarly located seats or the rest of Melbourne.
