...
but higher than for elsewhere (`r label_percent(accuracy=1)(pcol_rest_melbourne$data[1:4,3] %>% sum())`)^[Differences
...
Overall, Dandenong residents appear less likely to have less transit supply than Melbourne's average than those in surrounding seats, but more likely that those elsewhere. They were less likely than those elsewhere to have seen transit supply increase by 1% or more between 2021 and 2023. 
